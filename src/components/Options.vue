<template>
    <div class="h-full overflow-y-auto bg-zinc-100 dark:bg-zinc-800 rounded-md">
        <ul class="space-y-2 font-medium mt-5">
            <li class="cursor-pointer px-2" @click="goToPage(Feed)">
            ...
            <li class="cursor-pointer px-2" @click="goToPage(Explore)">
                <a class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-zinc-200 dark:hover:bg-zinc-700 group">
                  <svg class="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
           ...
           <li v-if="isLoggedIn" class="cursor-pointer px-2" @click="goToPage(PostManagement)">
              <a class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-zinc-200 dark:hover:bg-zinc-700 group">
                 <svg class="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
           ...
           <li v-if="isLoggedIn" class="cursor-pointer px-2" @click="goToPage(Bookmarks)">
              <a class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-zinc-200 dark:hover:bg-zinc-700 group">
                <svg class="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
         ...
         <li v-if="!isLoggedIn" class="cursor-pointer px-2" @click="goToLogIn(LogIn)">
...
const goToPage = (Page: any) => {
   dashboardMainDisplay.value = Page;
   location.hash = "";
}

const goToLogIn = (Page: any) => {
   mainDisplay.value = Page;
   location.hash = "";
}
</script>
